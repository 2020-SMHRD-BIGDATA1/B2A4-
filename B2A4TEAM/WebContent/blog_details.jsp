					...
					<div class="col-lg-8 posts-list">
						<div class="single-post">
							...
							<div class="blog_details">
								<h2 style="color: #2d2d2d;">Second divided from form fish
									beast made every of seas all gathered us saying he our</h2>
									...
									<div class="user justify-content-between d-flex">
										...
										<div class="desc">
											<p class="comment">Multiply sea night grass fourth day
												...
												give fill lesser bearing multiply sea night grass fourth day
												sea lesser</p>
						...
						<div class="comment-form">
							...
							<form class="form-contact comment_form" action="#"
								...
								<div class="form-group">
									<button type="submit"
										class="button button-contactForm btn_1 boxed-btn">Post
										Comment</button>
								</div>
							</form>
						</div>
